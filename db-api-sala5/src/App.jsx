  ...
  return (
    ...
    <div className="botao">
      ...
      <main>
        {data.map(item => {
          return(
           <Card unico={item.id} imagem={item.image} nome={item.name} especie={item.species} ki={item.ki} maxki={item.maxKi} raca={item.race} genero={item.gender} afiliacao={item.affiliation}/>
          )
        })}
      </main>
    </>
